...
public class InfoPanel implements Listener {
    ...
    public Inventory infoPanel(Island island, HashMap<Material, Long> values) {
        ...
        if (island == null) {
            ...
            for (Material mat : values.keySet()) {
                ...
                lore.add(ChatColor.GREEN + "Number of Blocks:");
                ...
                lore.add(ChatColor.GREEN + "Block Level:");
        ...
        if (ip.size() > 0) {
            ...
            int size = 18;
            String title = "Island Block Information";
            ...
            List<String> lore = new ArrayList<>();
            lore.add(ChatColor.GREEN + "update block counts");
            lore.add(ChatColor.GREEN + "Type /is level for.");
            meta.setLore(lore);
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (!inventory.getTitle().equalsIgnoreCase("Island Block Information")) {
            return;
        }
